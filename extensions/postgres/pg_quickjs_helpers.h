#ifndef PG_QUICKJS_HELPERS_H
#define PG_QUICKJS_HELPERS_H

/*
 * pg_quickjs_helpers.h — PostgreSQL QuickJS helper table.
 *
 ...
 * engine.c and redis_quickjs_helpers.h.  Both files include quickjs.h,
...
extern const script_helper postgres_quickjs_helpers[];
extern const size_t        postgres_quickjs_helpers_count;

#endif /* WRKX_HAVE_QUICKJS */
#endif /* PG_QUICKJS_HELPERS_H */
